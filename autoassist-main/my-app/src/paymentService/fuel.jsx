...
const PaymentPage = () => {
  ...
  const pricePerLiter = 97;
  const basePrice = pricePerLiter * liters;
  const gstAmount = Math.round(basePrice * 0.2);
  ...
  const translations = {
    English: {
      ...
      cancel: "Cancel",
      selectLiters: "Select Liters",
    },
    हिन्दी: {
      servicePayment: "सेवा भुगतान",
      basePrice: `मूल मूल्य: ₹${basePrice}`,
      gst: `जीएसटी (20%): ₹${gstAmount}`,
      total: `कुल: ₹${totalPrice}`,
  ...
  <div className="service-lang">
    ...
    >
      ...
      <style>{/* Keep your existing style unchanged */`
        * {
